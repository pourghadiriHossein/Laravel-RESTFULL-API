...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permission::create(['name' => Permissions::VIEW_ANY_COMMENT, 'guard_name' => 'api']);
        ...
        $admin->givePermissionTo(Permissions::VIEW_ANY_COMMENT);
        ...
        $user->givePermissionTo(Permissions::VIEW_ANY_COMMENT);
